...
contract MagicDropTokenImplRegistryUpgradeTest is Test {
    ...
    function test_UpgradeToV2() public {
        ...
        uint32 implId = registryPrxy.registerImplementation(
        ...
        // Upgrade to V2
        UUPSUpgradeable(registryProxy).upgradeToAndCall(
            address(registryV2),
            ""
        );
    ...
    function test_UpgradeWithInitializer() public {
        bytes memory initData = abi.encodeCall(
            MagicDropTokenImplRegistryV2.setMaxFee,
            (1 ether)
        );
    ...
    function test_MultipleUpgrades() public {
        ...
        assertEq(MagicDropTokenImplRegistry(payable(registryProxy)).getDefaultImplementationID(TokenStandard.ERC721), implIdV1);
