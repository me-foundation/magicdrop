...
contract MagicDropTokenImplRegistryTest is Test {
    ...
    function testRegisterImplementation() public {
        ...
        uint256 deploymentFee = registry.getDeploymentFee(
            TokenStandard.ERC721,
            implId
        );
    ...
    function testRegisterMultipleImplementations(
        uint256 numImplementations,
        ...
        for (uint256 i = 0; i < numImplementations; i++) {
            ...
            address impl = registry.getImplementation(
                TokenStandard.ERC721,
                implId
            );
            uint256 deploymentFee_ = registry.getDeploymentFee(
                TokenStandard.ERC721,
                implId
            );
            assertEq(impl, address(mockERC721));
    ...
    function testRegisterUnsupportedStandard() public {
        ...
        vm.expectRevert(
            MagicDropTokenImplRegistry
                .ImplementationDoesNotSupportStandard
                .selector
        );
    ...
    function testUnregisterImplementation() public {
        ...
        vm.expectRevert(
            MagicDropTokenImplRegistry.InvalidImplementation.selector
        );
    ...
    function testGetDefaultImplementationNotRegistered() public {
        vm.expectRevert(
            MagicDropTokenImplRegistry
                .DefaultImplementationNotRegistered
                .selector
        );
    ...
    function testGetDefaultImplementationID() public {
        ...
        uint32 defaultImplId = registry.getDefaultImplementationID(
            TokenStandard.ERC721
        );
